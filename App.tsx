          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 w-full max-w-4xl text-center mb-16">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-center gap-10">
                 <a href="https://www.instagram.com/adegaterceiroturno1?utm_source=qr&igsh=MWtrZ3V3ZWU1OXY0MQ%3D%3D" className="flex flex-col items-center gap-2 group transition-all">
                 ...
                 <a href="#" className="flex flex-col items-center gap-2 group transition-all">
